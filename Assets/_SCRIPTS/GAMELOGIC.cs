...
public class GAMELOGIC : MonoBehaviour {
	...
	void Start () {
		...
		if(PhotonNetwork.IsMasterClient){
			PP.RPC ("InitializeAllCards", RpcTarget.AllBuffered);
		}
	...
	void InitializePlayer ()
	{
		if(PhotonNetwork.LocalPlayer.CustomProperties.ContainsValue ("P1")){
			...
			LocalPlayerID = 0;
			LocalViewID = 1001;
			PP.RPC ("InitializePlayerToServer", RpcTarget.All, LocalPlayerID, LocalViewID, PhotonNetwork.LocalPlayer.NickName);
